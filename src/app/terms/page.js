...
const page = () => {
  ...
  <p>Welcome to Lifetime Fitness and Nutrition Center!</p>
        ...
        <h3 className="text-xl font-semibold text-[#3D3D3D] border-l-4 border-[#D58411] pl-3">
        ...
        <h3 className="text-xl font-semibold text-[#3D3D3D] border-l-4 border-[#D58411] pl-3">iFrames</h3>
        ...
        <h3 className="text-xl font-semibold text-[#3D3D3D] border-l-4 border-[#D58411] pl-3">Disclaimer</h3>
        ...
        <p>
          ...
          <p className="mt-8 text-xs sm:text-sm text-gray-500 italic border-t border-gray-200 pt-6">
            This Terms and Conditions was last updated on <strong>April 19, 2024</strong>.
          </p>
      </div>
    </section>
  );
